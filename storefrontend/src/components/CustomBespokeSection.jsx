...
const CustomBespokeSection = () => {
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
      <div className="grid items-center gap-8 overflow-hidden rounded-3xl bg-[#f8f5ef] p-6 shadow-sm md:grid-cols-2 md:p-10 lg:gap-12">
        {/* Left Image */}
        ...
        <div className="max-w-xl">
          ...
          >
            <Button className="h-11 rounded-full bg-[#8B5E3C] px-6 text-white hover:bg-[#7A5234]">
